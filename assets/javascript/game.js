...
(function () {
    ...
    function setup() {
        ...
        lives = 13;
        words = ["joy", "bliss", "heaven","love","luck","soul","solar","sun","light"];
        messages = {
            win: 'You escaped near death!',
            lose: 'Your life now belongs to me!!!',
            guessed: ' you guessed that silly...',
        ...
        man.innerHTML = 'You have ' + lives + 'tries until death';
        output.innerHTML = '';
